...
namespace ConsoleApp13.Models
{
    public partial class AdventureWorks2016Context : DbContext
    {
        ...
        public virtual DbSet<VwDesignation> VwDesignations { get; set; }
        public virtual DbSet<Vwemailhistory> Vwemailhistories { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPN222321\\MSSQL2019;Initial Catalog=AdventureWorks2016;Integrated Security=true;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Temp>(entity =>
            {
                ...
                entity.ToTable("temp", "HumanResources");
            ...
            modelBuilder.Entity<VwDesignation>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwDesignation");
            ...
            modelBuilder.Entity<Vwemailhistory>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vwemailhistory");
